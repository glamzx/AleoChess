...
const fallbackItems: StoreItem[] = [
  ...
  // Pieces
  item("pieces.default", "pieces", "Aleo Classic", "common", 0, { piece_theme: "cartoon" }, true, true),
  item("pieces.neon", "pieces", "Neon Knights", "rare", 200, { piece_theme: "cartoon" }),
  item("pieces.wooden", "pieces", "Wooden Craft", "rare", 250, { piece_theme: "cartoon" }),
  item("pieces.crystal", "pieces", "Crystal Set", "epic", 500, { piece_theme: "cartoon" }),
  item("pieces.obsidian", "pieces", "Obsidian Shadow", "epic", 600, { piece_theme: "cartoon" }),
  item("pieces.celestial", "pieces", "Celestial Gold", "legendary", 1200, { piece_theme: "cartoon" }),
  item("pieces.dragon", "pieces", "Dragon Forge", "mythic", null, { piece_theme: "cartoon" }, false, false, true),
  // Backgrounds
